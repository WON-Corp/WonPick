...
<title>WonPick 로그인</title>
	<style>
	        ...
	        #header{height: 40%;}
	        #footer{height: 10%; font-size: small; color: gray; padding-top: 30px;} 
	        #errorMessage {height: 40%; line-height: 80px; position: relative; padding-top: 30px;}
	        #findUser {height: 10%; padding-top: 5px; border-top: 2px solid gray; margin-left: 30px; margin-right: 30px;}
...
<form action="#######" method="post">
	<div class="wrap">
        <div id="header">
            <img src="../resources/logo.jpg" alt="" style="border-radius: 15px;"> <br>
            <h1><em>WonPick</em></h1>
        </div>
        <div id="errorMessage">
            <h1 align="center" style="color:red"><%= request.getAttribute("errorMsg") %></h1>

            <b>자세한 사항은 관리자에게 문의해주세요.</b>
            <br>
