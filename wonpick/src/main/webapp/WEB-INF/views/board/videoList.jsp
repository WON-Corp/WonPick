...
<body>
		...
		<script>
			location.href = "/wonpick/post/selectVideoList";
		</script>
		</c:if>
			                ...
			                <div class="feed">
			                    <div class="post">
			                        <div class="post-header">
			                            ...
			                            <img src="${ list.userPfImg }" onerror="src='/wonpick/resources/img/logo.jpg'" class="post-profile-img">
			                        </div>
			                        	<video src="${ list.imgFile }" class="post-image" controls autoplay loop></video>
			                        <img src="/wonpick/resources/img/sizing_space.jpg" alt="공백" class="post-image">
